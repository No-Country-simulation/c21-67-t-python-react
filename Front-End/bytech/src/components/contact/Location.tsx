export const Location = () => {
  return (
    <div className="grid grid-cols-1 items-center w-full sm:grid-cols-2">
      <div className="text-center h-full bg-primary">
        <p className="border-t border-b border-black pt-4 pb-4 text-white text-3xl m-4 font-semibold">
          MA
          <br />
          PA
        </p>
        ...
        <p className="mt-4 text-white">
          Horarios de atención: <br /> Lun a Vier 9 a 18hs <br />
          Sabados: 9 a 15hs
        </p>
      </div>
      <iframe
